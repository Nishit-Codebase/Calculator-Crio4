...
function App() {
  ...
  return (
   <div>
    ...
    <button onClick={()=>{setExp(""); setResult("0");}}>C</button> <button onClick={()=>{handleClick("0")}}>0</button> <button onClick={() => {setResult(eval(Exp).toString())}}>=</button> <button onClick={()=>{handleClick("/")}}>/</button><br/>
    </div>                                                                                                                                        
   </div>
  )
}
