...
function App() {
  ...
  return (
   <div>
    ...
    <input type="text" value={Exp} readOnly id="input" style={{marginLeft:"500px"}}></input><br/>
    {
      Result && 
    ...
    <button onClick={()=>{setExp(""); setResult("");}}>C</button> <button onClick={()=>{handleClick("0")}}>0</button> <button onClick={() => {setResult(eval(Exp));}}>=</button> <button onClick={()=>{handleClick("/")}}>/</button><br/>
    </div>                                                                                                                                        
   </div>
  )
}
